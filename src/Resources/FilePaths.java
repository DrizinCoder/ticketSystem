...
public class FilePaths {
     ...
     */
    public static final String USER_JSON = "src/Resources/json/user.json";

    /**
     * Caminho para o arquivo JSON que contém os dados dos cartões.
     */
    public static final String CARD_JSON = "src/Resources/json/card.json";

    /**
     * Caminho para o arquivo JSON que contém os dados dos eventos.
     */
    public static final String EVENT_JSON = "src/Resources/json/event.json";

    /**
     * Caminho para o arquivo JSON que contém os dados das compras.
     */
    public static final String PURCHASE_JSON = "src/Resources/json/purchase.json";

    /**
     * Caminho para o arquivo JSON que contém os dados dos ingressos.
     */
    public static final String TICKET_JSON = "src/Resources/json/ticket.json";

    /**
     * Caminho para o arquivo JSON que contém os dados das avaliações.
     */
    public static final String REVIEW_JSON = "src/Resources/json/review.json";
}